...
interface ModuleIndexContentProps {
  module: TutorialModule;
  categorySlug: string;
}

export default function ModuleIndexContent({
  module,
  categorySlug,
}: ModuleIndexContentProps) {
  return (
    <div className="min-h-screen bg-surface px-6 py-20 md:px-[100px]">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-text-secondary">{module.description}</p>
      </div>
